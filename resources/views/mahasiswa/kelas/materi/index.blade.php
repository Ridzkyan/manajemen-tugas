...
<div class="container">
            ...
            @foreach($materis as $materi)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    @elseif($materi->tipe == 'video' || $materi->link)
                        <a href="{{ $materi->link }}" class="btn btn-sm btn-outline-info" target="_blank" rel="noopener noreferrer">▶ Tonton Video</a>
                    @else
    ...
    <a href="{{ route('mahasiswa.kelas.show', $kelas->id) }}" class="btn btn-secondary mt-3">⬅ Kembali</a>
</div>
@endsection